import { LayoutDashboard, HardHat, Truck, Users, ShieldCheck, Zap, Settings, LogOut } from 'lucide-react';
...
const boardIcons: Record<string, typeof HardHat> = {
  ...
  return (
    <aside className="w-64 bg-brand-800 text-white flex flex-col h-screen fixed left-0 top-0">
      ...
      <nav className="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
        ...
        {boards.map((board) => {
          const Icon = boardIcons[board.name] || HardHat;
          return (
            <button
              key={board.id}
