...
export function ColumnRenderer({ column, value, compact = false }: ColumnRendererProps) {
  ...
  switch (column.columnType) {
    ...
    case 'date': {
      const dateStr = typeof value === 'object' && value.date ? value.date : String(value);
    ...
    case 'url': {
      ...
      const displayText = typeof value === 'object' && value.text ? value.text : url;
      const truncated = compact && displayText.length > 25
