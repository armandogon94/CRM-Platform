# TrustGuard QA — Slice 19.7

**Slug:** `trustguard`
**Port:** 13003
**Admin user:** `admin@trustguard.com`
...
- [ ] 4. Navigate to board — _Expected 'Policies' not found; clicked 'Claims Pipeline'_
...
- Screenshots: `qa-results/trustguard/screenshots/` (10 PNGs)
- API log: `qa-results/trustguard/api-log.json` (3 requests)
