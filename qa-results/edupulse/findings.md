# EduPulse QA — Slice 19.7

**Slug:** `edupulse`
**Port:** 13010
**Admin user:** `admin@edupulse.com`
...
- [ ] 4. Navigate to board — _Neither 'Courses' nor fallback board buttons found_
...
- Screenshots: `qa-results/edupulse/screenshots/` (10 PNGs)
- API log: `qa-results/edupulse/api-log.json` (3 requests)
