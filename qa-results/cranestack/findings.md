# CraneStack QA — Slice 19.7

**Slug:** `cranestack`
**Port:** 13009
**Admin user:** `admin@cranestack.com`
...
- [ ] 4. Navigate to board — _Expected 'Projects' not found; clicked 'Project Pipeline'_
...
- Screenshots: `qa-results/cranestack/screenshots/` (10 PNGs)
- API log: `qa-results/cranestack/api-log.json` (3 requests)
