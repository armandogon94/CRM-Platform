# TableSync QA — Slice 19.7

**Slug:** `tablesync`
**Port:** 13008
**Admin user:** `admin@tablesync.com`
...
- [ ] 4. Navigate to board — _Neither 'Reservations' nor fallback board buttons found_
...
- Screenshots: `qa-results/tablesync/screenshots/` (10 PNGs)
- API log: `qa-results/tablesync/api-log.json` (3 requests)
