...
export function LoginPage() {
  const { login } = useAuth();
  const [email, setEmail] = useState('admin@trustguard.com');
    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-700 via-brand-600 to-brand-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">TrustGuard</h1>
          <p className="text-brand-200 mt-2">Insurance Policy & Claims Management</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="admin@trustguard.com"
                required
              />
            </div>
            <div>
          ...
          <div className="mt-6 p-3 bg-brand-50 rounded-lg">
            ...
            <p className="text-xs text-brand-600">
              Email: admin@trustguard.com | Password: demo123
            </p>
          </div>
        </div>
      </div>
