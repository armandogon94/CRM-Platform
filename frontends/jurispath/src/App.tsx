...
function AppContent() {
  ...
  // subscription + room joining, authenticated via the jurispath_token
      ...
      return (
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-500">
            Manage workflow automations across all JurisPath boards
          </p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-500">Loading JurisPath...</p>
        </div>
      </div>
    );
  }
