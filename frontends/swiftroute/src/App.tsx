...
function AppContent() {
  ...
  // Slice 20.5 B: BoardPage now owns its own data + WebSocket via the
  // shared useBoard hook. AppContent no longer threads currentBoard /
  // currentItems / boardLoading state, no longer maintains a local
  // socket.io listener for setCurrentItems, and no longer emits the
  // board:join handshake. useBoard's internal useWebSocket handles
  // subscription + room joining, authenticated via the swiftroute_token
      ...
      return (
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-500">
            Manage workflow automations across all SwiftRoute boards
          </p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-500">Loading SwiftRoute...</p>
        </div>
      </div>
    );
  }
