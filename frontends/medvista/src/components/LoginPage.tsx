...
export function LoginPage() {
  const { login } = useAuth();
  const [email, setEmail] = useState('admin@medvista.com');
    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-800 via-brand-700 to-brand-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">MedVista</h1>
          <p className="text-brand-300 mt-2">Multi-Specialty Medical Group CRM</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="admin@medvista.com"
                required
              />
            </div>
            <div>
          ...
          <div className="mt-6 p-3 bg-brand-50 rounded-lg">
            ...
            <p className="text-xs text-brand-600">
              Email: admin@medvista.com | Password: demo123
            </p>
          </div>
        </div>
      </div>
