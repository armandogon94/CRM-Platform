...
function AppContent() {
  ...
  // subscription + room joining, authenticated via the medvista_token
      ...
      return (
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-500">
            Manage workflow automations across all MedVista boards
          </p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-500">Loading MedVista...</p>
        </div>
      </div>
    );
  }
