...
// Slice 20.5 — align shared utilities with MedVista's existing token key
// so useBoard's WebSocket connection authenticates correctly.
configureApi({ tokenKey: 'medvista_token' });
configureWebSocket({ tokenKey: 'medvista_token' });

// <ToastProvider> mounts below <AuthProvider> so the app tree has access
// to useToast(). Required by the BoardPage CRUD wiring (Slice 20 C2)
