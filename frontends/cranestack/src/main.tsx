...
// Slice 20.5 — align shared utilities with CraneStack's existing token key
// so useBoard's WebSocket connection authenticates correctly.
configureApi({ tokenKey: 'cranestack_token' });
configureWebSocket({ tokenKey: 'cranestack_token' });
