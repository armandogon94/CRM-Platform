...
/**
 * CraneStack state-based board page (Slice 20B C2 CRUD wiring).
 *
 * Like MedVista (router-less), CraneStack's parent App.tsx drives board
 ...
 *
 * C2 migrates from CraneStack's local KanbanView/BoardTable fork to the
 * shared BoardView. Three CRUD callbacks are wired through to the
 * CraneStack-local REST client (which uses the `cranestack_token` key
