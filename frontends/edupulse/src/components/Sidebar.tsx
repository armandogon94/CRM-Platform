import { LayoutDashboard, Users, BookOpen, ClipboardCheck, ClipboardList, Zap, Settings, LogOut } from 'lucide-react';
...
const boardIcons: Record<string, typeof Users> = {
  ...
  'Assignment Tracker': ClipboardCheck,
};
    ...
    <aside className="w-64 bg-brand-800 text-white flex flex-col h-screen fixed left-0 top-0">
      ...
      <div className="p-5 border-b border-brand-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-lg leading-tight">EduPulse</h1>
            <p className="text-brand-300 text-xs">Education CRM</p>
          </div>
        </div>
      </div>
